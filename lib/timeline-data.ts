...
export const TIMELINE_GROUPS: TimelineGroup[] = [
  {
    id: 'paul-life-and-journeys',
    title: "Paul's Life & Journeys",
    dateLabel: 'c. AD 34–67',
    startYear: 34,
    endYear: 67,
    autoExpandZoom: 1.35,
  },
...
export const SEED_EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    year: 35,
    dateLabel: 'c. AD 34–36',
    title: 'Conversion of Paul',
    tradition: 'undivided',
    parents: [],
    kind: 'event',
    icon: { type: 'lucide', name: 'Sun' },
    summary: 'Saul of Tarsus encounters the risen Jesus while travelling to Damascus and becomes a Christian.',
    detail: 'According to Acts 9, Saul was travelling to arrest followers of Jesus when a heavenly light stopped him. After Ananias baptised him, the former persecutor became the most influential missionary to the Gentile world.',
    keyFigures: ['Paul of Tarsus', 'Ananias of Damascus'],
    links: [{ label: 'Conversion of Paul — Wikipedia', url: wiki('Conversion_of_Paul_the_Apostle') }],
    groupId: 'paul-life-and-journeys',
  },
  {
    ...
    summary: 'Paul and Barnabas carry the gospel from Antioch through Cyprus and southern Asia Minor.',
    detail: 'Sent by the church at Antioch, Paul and Barnabas preached in synagogues and founded mixed Jewish-Gentile communities across Cyprus and the cities of southern Asia Minor.',
    keyFigures: ['Paul of Tarsus', 'Barnabas', 'John Mark'],
    links: [{ label: "Paul's first journey — Wikipedia", url: wiki('First_missionary_journey') }],
    groupId: 'paul-life-and-journeys',
  },
  {
    ...
    summary: 'Paul crosses into Macedonia and plants churches at Philippi, Thessalonica, Berea and Corinth.',
    detail: 'Travelling with Silas and later Timothy and Luke, Paul carried the mission into Europe. He addressed the Areopagus in Athens and remained in Corinth for roughly eighteen months.',
    keyFigures: ['Paul of Tarsus', 'Silas', 'Timothy', 'Luke'],
    links: [{ label: 'Paul the Apostle — Wikipedia', url: wiki('Paul_the_Apostle') }],
    groupId: 'paul-life-and-journeys',
  },
  {
    ...
    summary: 'Paul strengthens earlier churches and conducts an extended ministry in Ephesus.',
    detail: 'Ephesus became the centre of Paul’s longest sustained ministry. From there the message spread through Roman Asia while Paul corresponded with churches and gathered aid for Jerusalem.',
    keyFigures: ['Paul of Tarsus', 'Timothy', 'Titus'],
    links: [{ label: 'Paul the Apostle — Wikipedia', url: wiki('Paul_the_Apostle') }],
    groupId: 'paul-life-and-journeys',
  },
  {
    ...
    summary: 'Paul is seized after returning to Jerusalem and spends two years imprisoned at Caesarea.',
    detail: 'A disturbance in the temple led Roman soldiers to take Paul into custody. He defended himself before Jewish and Roman authorities and appealed his case to Caesar as a Roman citizen.',
    keyFigures: ['Paul of Tarsus', 'Felix', 'Festus'],
    links: [{ label: 'Paul the Apostle — Wikipedia', url: wiki('Paul_the_Apostle') }],
    groupId: 'paul-life-and-journeys',
  },
  {
    id: 'paul-voyage-rome',
    year: 60,
    dateLabel: 'c. AD 60–61',
    title: "Paul's Voyage to Rome",
    tradition: 'undivided',
    parents: [],
    kind: 'event',
    icon: { type: 'lucide', name: 'Anchor' },
    summary: 'Paul travels to Rome as a prisoner, surviving a shipwreck on Malta.',
    detail: 'Acts closes with a vivid account of storm, shipwreck and winter on Malta. Paul eventually reached Rome and lived under house arrest while preaching openly.',
    keyFigures: ['Paul of Tarsus', 'Luke', 'Julius the centurion'],
    links: [{ label: 'Paul the Apostle — Wikipedia', url: wiki('Paul_the_Apostle') }],
    groupId: 'paul-life-and-journeys',
  },
  {
    id: 'martyrdom-of-paul',
    year: 67,
    dateLabel: 'c. AD 64–67',
    title: 'Martyrdom of Paul',
    tradition: 'undivided',
    parents: [],
    kind: 'event',
    icon: { type: 'lucide', name: 'Swords' },
    summary: 'Early Christian tradition holds that Paul is executed at Rome during Nero’s persecution.',
    detail: 'The New Testament does not narrate Paul’s death, but early testimony associates his martyrdom with Rome. Later tradition says his Roman citizenship led to execution by beheading.',
    keyFigures: ['Paul of Tarsus', 'Nero'],
    links: [{ label: 'Paul the Apostle — Wikipedia', url: wiki('Paul_the_Apostle') }],
    groupId: 'paul-life-and-journeys',
  },
  {
